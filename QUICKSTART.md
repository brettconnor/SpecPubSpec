...
4. **Leave REQ-016 and REQ-031's checks alone**: the required-directories check (`scripts/`, `site/app/`, `site/components/`) and the requirement that `QUICKSTART.md` contain this Bootstrapping section govern the site-generator scaffold and this onboarding doc itself, not your spec's subject matter — they apply unchanged regardless of your domain.
